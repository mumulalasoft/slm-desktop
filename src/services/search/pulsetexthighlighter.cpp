#include "pulsetexthighlighter.h"

#include <QRegularExpression>

PulseTextHighlighter::PulseTextHighlighter(QObject *parent)
    : QObject(parent)
{
}

QString PulseTextHighlighter::highlightStyledText(const QString &title,
                                                      const QString &query,
...
QString PulseTextHighlighter::escapeHtml(const QString &value)
{
    QString out = value;
