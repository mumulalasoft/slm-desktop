...
const QList<Entry> &capabilityTable()
{
    static const QList<Entry> table{
        ...
        {Capability::SharingManageFiles, QStringLiteral("Sharing.ManageFiles")},
        {Capability::SharingManageNearby, QStringLiteral("Sharing.ManageNearby")},
        {Capability::SharingManageScreen, QStringLiteral("Sharing.ManageScreen")},
        {Capability::SharingManagePrinters, QStringLiteral("Sharing.ManagePrinters")},
        {Capability::SharingManageRemoteAccess, QStringLiteral("Sharing.ManageRemoteAccess")},
        {Capability::SharingManageMedia, QStringLiteral("Sharing.ManageMedia")},
        {Capability::SharingManageClipboard, QStringLiteral("Sharing.ManageClipboard")},
        {Capability::NearbyDiscover, QStringLiteral("Nearby.Discover")},
        {Capability::NearbyConnect, QStringLiteral("Nearby.Connect")},
        {Capability::NearbyTrustManage, QStringLiteral("Nearby.TrustManage")},
        ...
        {Capability::PortalWallpaper, QStringLiteral("Portal.Wallpaper")},
        {Capability::PortalBackgroundNotify, QStringLiteral("Portal.BackgroundNotify")},
        {Capability::PortalBackgroundAutostart, QStringLiteral("Portal.BackgroundAutostart")},
