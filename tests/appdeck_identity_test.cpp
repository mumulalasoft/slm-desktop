...
#include "../src/core/appdeck/appdeckidentity.h"
using namespace AppDeckIdentity;

class AppDeckIdentityTest : public QObject {
    Q_OBJECT
...
QTEST_MAIN(AppDeckIdentityTest)
#include "appdeck_identity_test.moc"
