...
void PortalProfileSnapshotTest::beta_profile_snapshot_contract()
{
    ...
    const KV expected{
        ...
        {QStringLiteral("org.freedesktop.impl.portal.Wallpaper"), QStringLiteral("slm")},
        {QStringLiteral("org.freedesktop.impl.portal.Background"), QStringLiteral("slm")},
        {QStringLiteral("org.freedesktop.impl.portal.Print"), QStringLiteral("slm")},
