...
class AppDeckControllerSsotContractTest : public QObject
{
    Q_OBJECT
...
private slots:
    ...
    {
        const QString path = QStringLiteral(DESKTOP_SOURCE_DIR) + QStringLiteral("/Qml/AppDeckController.qml");
...
QTEST_MAIN(AppDeckControllerSsotContractTest)
#include "appdeckcontroller_ssot_contract_test.moc"
