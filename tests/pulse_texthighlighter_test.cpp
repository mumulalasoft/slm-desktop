...
class PulseTextHighlighterTest : public QObject
{
    Q_OBJECT
...
private slots:
    void noQuery_returnsEscapedPlainText()
    {
        ...
        const QString out = PulseTextHighlighter().highlightStyledText(
...
QTEST_MAIN(PulseTextHighlighterTest)
#include "pulse_texthighlighter_test.moc"
