...
class PulseContextMenuHelperTest : public QObject
{
    Q_OBJECT
...
void PulseContextMenuHelperTest::actionLayoutByEntryType()
{
    PulseContextMenuHelper helper;
...
void PulseContextMenuHelperTest::actionForSlotMapping()
{
    PulseContextMenuHelper helper;
...
void PulseContextMenuHelperTest::selectionNormalizeAndWrap()
{
    PulseContextMenuHelper helper;
...
QTEST_MAIN(PulseContextMenuHelperTest)
#include "pulse_contextmenuhelper_test.moc"
